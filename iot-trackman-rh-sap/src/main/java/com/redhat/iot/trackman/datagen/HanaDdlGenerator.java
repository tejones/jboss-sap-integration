...
final class HanaDdlGenerator extends TrackManDataGenerator {
    ...
    private static final String SHOT_PATTERN = "INSERT INTO shot VALUES ( '%s', %s, '%s', %s, TIMESTAMP '%s', %s, %s, %s, %s, %s, %s, %s, %s, %s );";
    ...
    protected void generateCreateTableStatements( final StringBuilder builder ) {
        // schema
        builder.append( "--\n" );
        builder.append( "-- TRACKMAN Schema\n" );
        builder.append( "--\n" );
        builder.append( "CREATE SCHEMA trackman;" ).append( '\n' );
        builder.append( "SET SCHEMA trackman;" ).append( '\n' ).append( '\n' );
        ...
        builder.append( "    id INTEGER GENERATED ALWAYS AS IDENTITY," ).append( '\n' );
        ...
        builder.append( "    PRIMARY KEY ( id )," ).append( '\n' );
        builder.append( "    UNIQUE CPBTREE ( shotId, dataPointIndex )," ).append( '\n' );
        builder.append( "    FOREIGN KEY ( shotId ) REFERENCES shot ( id )" ).append( '\n' );
        builder.append( ");" ).append( '\n' ).append( '\n' );
    ...
    protected void generateDropStatements( final StringBuilder builder ) {
        builder.append( "DROP TABLE trajectoryCoefficient;" ).append( '\n' );
        builder.append( "DROP TABLE ballTrajectory;" ).append( '\n' );
        builder.append( "DROP TABLE ballPosition;" ).append( '\n' );
        builder.append( "DROP TABLE shot;" ).append( '\n' );
        builder.append( "DROP TABLE hole;" ).append( '\n' );
        builder.append( "DROP TABLE course;" ).append( '\n' );
        builder.append( "DROP TABLE trackmanMessage;" ).append( '\n' );
        builder.append( "DROP TABLE player;" ).append( '\n' );
        builder.append( "DROP SCHEMA trackman;" ).append( '\n' );
    }
